...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 1000 * 60 * 60; // Dash: 1 day
        consensus.nPowTargetSpacing = 0.1 * 60; // Dash: 2.5 minutes
        ...
        genesis = CreateGenesisBlock(1495216539, 29562459, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000008487c279ad5d8f3c066017c4079ace1f46d5ee884f7b38b3bceb852954e"));
        assert(genesis.hashMerkleRoot == uint256S("0xe0028eb9648db56b1ac77cf090b99048a8007e2bb64b68f092c03c7f56a662c7"));


        vSeeds.push_back(CDNSSeedData("ulmsecure.ddns.net", "ulmsecure.ddns.net"));

        // Dash addresses start with 'U'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,68);
        // Dash script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // Dash private keys start with 'u'
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x000008487c279ad5d8f3c066017c4079ace1f46d5ee884f7b38b3bceb852954e")),
            1495216539, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1495216539UL, 3861911736UL, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000056692c542e9ed267a15783193b7787ef9df307fde89dc4a7e1a17a99c61"));
        assert(genesis.hashMerkleRoot == uint256S("0xe0028eb9648db56b1ac77cf090b99048a8007e2bb64b68f092c03c7f56a662c7"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x0000056692c542e9ed267a15783193b7787ef9df307fde89dc4a7e1a17a99c61")),
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1495216539, 1096448, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0ec67eadbbcc65891633a93ccdac744bc93c2f87b74983d323da7c9027915945"));
        assert(genesis.hashMerkleRoot == uint256S("0xe0028eb9648db56b1ac77cf090b99048a8007e2bb64b68f092c03c7f56a662c7"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x0ec67eadbbcc65891633a93ccdac744bc93c2f87b74983d323da7c9027915945")),
            0,
            0,
            0
        };
