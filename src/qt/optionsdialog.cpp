    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ULM-light"), QVariant("light"));
    ui->theme->addItem(QString("ULM-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ULM-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ULM-traditional"), QVariant("trad"));
