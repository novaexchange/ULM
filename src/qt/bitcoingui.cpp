    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Ulm Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Ulm address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ulm: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Ulm Core"), this);
    aboutAction->setStatusTip(tr("Show information about Ulm Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Ulm Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Ulm addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Ulm addresses"));
    ...
    openAction->setStatusTip(tr("Open a ulm: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Ulm Core help message to get a list with possible Ulm Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Ulm Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Ulm network", "", count));
}
...
{
    QString strTitle = tr("Ulm Core"); // default title
