    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Ulm Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Ulm Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  ulm-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Ulm in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ULM, 0.1 ULM, 1 ULM and 10 ULM -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://ulmpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://ulmpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Ulm Core is shutting down...") + "<br /><br />" +
