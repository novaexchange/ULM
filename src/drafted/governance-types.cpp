...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "UlmNetwork") type = UlmNetwork;
    if(strType == "UlmNetworkVariable") type = UlmNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == UlmNetwork) s = "UlmNetwork";
    if(type == UlmNetworkVariable) s = "UlmNetworkVariable";
