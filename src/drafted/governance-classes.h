 ...
 *
 *   // network
 *   CUlmNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.ulm.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CUlmNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: UlmNetwork
// //   -- signature requirements : Key1(User)
// class CUlmNetworkVariable : public CGovernanceObject
// {
// private:
