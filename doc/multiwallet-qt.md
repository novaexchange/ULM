...
Only requiring some minor changes is ulm.cpp.
...
Changes to ulm.cpp
----------------------
ulm.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
