...
This mechanism has been integrated into Bitcore-Node-Ulm which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ulmpay/insight-api-ulm#web-socket-api](https://github.com/ulmpay/insight-api-ulm#web-socket-api) 
* API: [https://github.com/ulmpay/insight-api-ulm#instantsend-transactions](https://github.com/ulmpay/insight-api-ulm#instantsend-transactions) 
...
By default, the Ulm Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Ulm Core daemon:
